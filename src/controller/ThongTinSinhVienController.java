...
public class ThongTinSinhVienController implements Action, MouseListener{
	public ThongTinSinhVienView view;

	public ThongTinSinhVienController(ThongTinSinhVienView view) {
		super();
		this.view = view;
	}
